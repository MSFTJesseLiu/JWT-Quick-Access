...
**However, this short live JWT token will be expired soon, and what I found super annoying was I have to go through the above steps to get a new token, and comment out the [Authorization] attribute in the code is not a good way since some operation need you to be authenticated. So recently I wrote this tiny project to have all the above steps done programmatically in one click.**
